...
# Product.create(:name =>'Baby-Boy Perfect Gift',:category_id =>'2',:description=>'',:image=>'pro_05',:price=>'22.40',:status => true)
# Product.create(:name =>'Luxury Grand Prix Rose Hand tied',:category_id =>'2',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'pro_06',:price=>'26.40',:status => true)
# Product.create(:name =>'Pink Perfect Gift',:category_id =>'2',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'pro_07',:price=>'21.60',:status => false)
# Product.create(:name =>'Vibrant Exquisite Arrangement',:category_id =>'2',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'pro_08',:price=>'34.00 ',:status => true)
# Product.create(:name =>'Vera Wang Purest Grace',:category_id =>'2',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'pro_09',:price=>'88.00',:status => false)
# Product.create(:name =>'Luxury Red Wine Gift Basket',:category_id =>'2',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'pro_10',:price=>'38.40',:status => true)
# Product.create(:name =>'Heavenly Red Rose Hand tied',:category_id =>'2',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'pro_11',:price=>'32.00',:status => false)
# Product.create(:name =>'Fairtrade Golden Autumn Hand tied',:category_id =>'2',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'pro_12',:price=>'16.00 ',:status => true)
# Product.create(:name =>'Gerbera and Vanda Orchid',:category_id =>'2',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'pro_13',:price=>'30.00 ',:status => true)

# Product.create(:name =>'Autumn Basket',:category_id =>'3',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'pro_14',:price=>'20.00 ',:status => false)
# Product.create(:name =>'Autumn Brights Globe',:category_id =>'3',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'pro_15',:price=>'35.10 ',:status => true)
# Product.create(:name =>'Happy Birthday Kalanchoe Basket',:category_id =>'3',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'pro_016',:price=>'32.40 ',:status => false)
# Product.create(:name =>'Mixed Basket Pink and Lilac',:category_id =>'3',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'pro_017',:price=>'27.00 ',:status => false)

# Product.create(:name =>'New Baby Flower',:category_id =>'4',:description=>'What do we do when we want to show our thankfulness? We send a card, a gift or something like that. ..',:image=>'pro_18',:price=>'32.00 ')

# Product.create(:name =>'Santa’s Workshop',:category_id =>'5',:description=>'Santa\'s elves have been hard at work! This wonderfully fragrant tree is a true testament that good things do come in little packages. ',:image=>'pro_09.jpeg',:price=>'23.00 ',:status => true)
# Product.create(:name =>'Christmas Tulips',:category_id =>'5',:description=>'Red, white and green… Santa’s favorite colors! Tulips are bold flowers in rich colors that just can’t be ignored, and they can make your presence felt during the Holiday Season without making a bold proclamation of undying affection.',:image=>'pro_20.jpeg',:price=>'24.00 ',:status => true)
